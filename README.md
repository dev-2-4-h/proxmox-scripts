...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/dev-2-4-h/proxmox-scripts/main/create.sh)"
```
...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/dev-2-4-h/proxmox-scripts/main/create.sh)" -s --app nginx-proxy-manager --cleanup
```
...
```sh
sh -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/dev-2-4-h/proxmox-scripts/main/install.sh)" -s --app nginx-proxy-manager
```
...
[Nginx Proxy Manager](https://github.com/dev-2-4-h/proxmox-scripts/tree/main/apps/nginx-proxy-manager)
